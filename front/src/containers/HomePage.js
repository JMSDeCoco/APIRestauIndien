          ...
          <Row>
            <Col md="6">
              <div className="texte_presentation p-4">
                ...
                <div>
                  <p>
                    Nous pratiquons la cuisine indienne, traditionnelle, et même
                    moderne afin de satisfaire tous les goûts et toutes les
                    envies. Notre restaurant est ancré dans les valeurs et la
                    culture indienne, des parfums aux saveurs en passant par les
                    sons et lenvironnement, vous serez en immersion totale dans
                    la culture indienne.
                  </p>
                </div>
              </div>
        ...
        <Container>
          <Row className="justify-content-md-center">
            <Col>
              ...
              <div>
                <p>
                  {" "}Lundi 12h - 14h30 / 19h - 23h30 <br />
                  Mardi 12h - 14h30 / 19h - 23h30 <br />
                  Mercredi 12h - 14h30 / 19h - 23h30 <br />
                  Jeudi 12h - 14h30 / 19h - 23h30 <br />
                  Vendredi 12h - 14h30 / 19h - 23h30 <br />
                  Samedi 12h - 14h30 / 19h - 23h30 <br />
                  Dimanche 12h - 14h30 / 19h - 23h30 <br />
                </p>
              </div>
            </Col>
            <Col>
      ...
      <Container className="carte">
        <Row className="justify-content-md-center">
          <Col xs lg="12">
            <h5>Adresse :</h5>
            <p>
              Immeuble Le Sésame, 8 Rue Germain Soufflot, 78180
